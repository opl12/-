...
import com.ying.jianxuan.ui.ui.zfa.list.DownPicUtil;
...
public class main extends AppCompatActivity {
    ...
    public void web(final X5WebView webView){
        ...
        void Threa(final String url, final Handler handler){
            new Thread(){
                @Override
                public void run() {
                    super.run();
                    try {
                        ...
                        Element element = doc.getElementById("newsContent");
                        Elements e=element.getElementsByTag("span");
                        //content是后台返回的h5标签
                        Message message=new Message();
                        message.obj=getHtmlData(element.html().replace("..","https://www.lantianla.cn"));
