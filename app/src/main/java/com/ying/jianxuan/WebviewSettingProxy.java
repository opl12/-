...
public class WebviewSettingProxy  {
    private final String LOG_TAG = "halfman";

    public final String APPLICATION_NAME = "android.app.Application";
    ...
    public  boolean revertBackProxy(WebView webview, String applicationClassName) {
        // 3.2 (HC) or lower
        if (Build.VERSION.SDK_INT <= 13) {
            return true;
        }
    ...
    public boolean setProxyUpToHC(WebView webview, String host, int port) {
    ...
    @SuppressWarnings("all")
    public boolean setProxyICS(WebView webview, String host, int port) {
        try {
    ...
    public boolean revertProxyICS(WebView webview) {
        try {
            Log.d(LOG_TAG, "Setting proxy with 4.0 API.");
     ...
     */
    @SuppressWarnings("all")
    public boolean setProxyJB(WebView webview, String host, int port) {
    ...
    public boolean revertProxyJB(WebView webview) {
    ...
    @SuppressLint("NewApi")
    @SuppressWarnings("all")
    public boolean setProxyKKPlus(WebView webView, String host, int port, String applicationClassName) {
    ...
    @SuppressLint("NewApi")
    @SuppressWarnings("all")
    public boolean revertProxyKKPlus(WebView webView, String applicationClassName) {
...
//                        intent.putExtra("proxy", null);
    ...
    public   Object getFieldValueSafely(Field field, Object classInstance) throws IllegalArgumentException, IllegalAccessException {
