...
public class fragmnet_adapter extends FragmentPagerAdapter {
    ...
    public fragmnet_adapter(FragmentManager fm, List<Fragment> fragments) {
        super(fm);
